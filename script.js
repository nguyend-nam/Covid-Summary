...
function getData(d, ctrn){
	...
	if(ctrn == 'Global'){
		...
		// 	content += '</div></div>';
		// }
		content += '<div class="card"><div class="info">No country name found or not the same as given in API. Please try again or take a few minutes to glance over the API docs below.</div></div>';
	}
